...
2. Consider the verifier.
   ...
   `configtx.yaml in the Hyperledger Java SDK sample <https://github.com/hxx258456/fabric-sdk-java/blob/{BRANCH}/src/test/fixture/sdkintegration/e2e-2Orgs/v1.3/configtx.yaml>`_:
...
The `cid (Client Identity) library <https://godoc.org/github.com/hxx258456/fabric-chaincode-go/pkg/cid>`_
...
For an example of setting an affiliation in the Java SDK see this `sample <https://github.com/hxx258456/fabric-sdk-java/blob/{BRANCH}/src/test/java/org/hyperledger/fabric/sdkintegration/End2endIdemixIT.java#L121>`_.

For an example of using the CID library in go chaincode to retrieve attributes,
see this `go chaincode <https://github.com/hxx258456/fabric-sdk-java/blob/{BRANCH}/src/test/fixture/sdkintegration/gocc/sampleIdemix/src/github.com/example_cc/example_cc.go#L88>`_.
