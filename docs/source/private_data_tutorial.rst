...
This tutorial will deploy the `asset transfer private data sample <https://github.com/hxx258456/fabric-samples/tree/main/asset-transfer-private-data/chaincode-go>`__
...
For implementation details refer to the following two `asset transfer private data functions <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-private-data/chaincode-go/chaincode/asset_queries.go>`__:
...
alongside the chaincode. An example index is available `here <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}//asset-transfer-private-data/chaincode-go/META-INF/statedb/couchdb/collections/assetCollection/indexes/indexOwner.json>`__ .
