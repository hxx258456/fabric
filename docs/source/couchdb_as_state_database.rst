...
The `asset transfer Fabric sample <https://github.com/hxx258456/fabric-samples/blob/main/asset-transfer-ledger-queries/chaincode-go/asset_transfer_ledger_chaincode.go>`__
...
The sample index can be found `here <https://github.com/hxx258456/fabric-samples/blob/main/asset-transfer-ledger-queries/chaincode-go/META-INF/statedb/couchdb/indexes/indexOwner.json>`__.
