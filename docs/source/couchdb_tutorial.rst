...
Throughout this tutorial, we will use the `Asset transfer ledger queries sample <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-ledger-queries/chaincode-go>`__
...
sample <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-ledger-queries/chaincode-go/asset_transfer_ledger_chaincode.go>`__.
...
The `Asset transfer ledger queries sample <https://github.com/hxx258456/fabric-samples/tree/{BRANCH}/asset-transfer-ledger-queries/chaincode-go>`__  below illustrates how the index
...
<https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-ledger-queries/chaincode-go/asset_transfer_ledger_chaincode.go>`__
...
data to an external database, visit the `Off chain data sample <https://github.com/hxx258456/fabric-samples/tree/{BRANCH}/off_chain_data>`__
in the Fabric Samples.
...
We will use the `Asset transfer ledger queries sample <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-ledger-queries/chaincode-go/asset_transfer_ledger_chaincode.go>`__
...
function in the `Asset transfer ledger queries sample <https://github.com/hxx258456/fabric-samples/blob/{BRANCH}/asset-transfer-ledger-queries/chaincode-go/asset_transfer_ledger_chaincode.go>`__.
