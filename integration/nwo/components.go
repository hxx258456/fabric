...
func (c *Components) ConfigTxGen() string {
	return c.Build("github.com/hxx258456/fabric/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("github.com/hxx258456/fabric/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("github.com/hxx258456/fabric/cmd/discover")
}
...
func (c *Components) Orderer() string {
	return c.Build("github.com/hxx258456/fabric/cmd/orderer")
}

func (c *Components) Osnadmin() string {
	return c.Build("github.com/hxx258456/fabric/cmd/osnadmin")
}

func (c *Components) Peer() string {
	return c.Build("github.com/hxx258456/fabric/cmd/peer")
}
